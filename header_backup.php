...
$current_date_time = date('l, F j, Y h:i A'); // Example format: Monday, February 19, 2025 10:30 AM

// Check if data is valid
if ($data && $data['cod'] == 200) {
    $temperature = $data['main']['temp']; // Current temperature
    $iconCode = $data['weather'][0]['icon']; // Weather icon code
    $iconUrl = "https://openweathermap.org/img/wn/{$iconCode}@2x.png"; // Icon URL
}
?>
...
<body>
    ...
    <a class="navbar-brand" style="display: flex; align-items: center; gap: 10px;">
    <img src="cloudy.png" style="width: 50px; height: 50px; border-radius: 8px;" alt="Weather Icon">
    <div style="display: flex; flex-direction: column;">
        <span style="font-size: 16px; font-weight: bold;"><?php echo $temperature; ?>°C</span>
